state ("RoboQuest-Win64-Shipping") {
    int GameLevel : 0x04985730, 0x120, 0x388;
    float GameTime : 0x04985730, 0x120, 0x678;
    float TotalRunTime : 0x04985730, 0x120, 0x680;
    bool bIsDead : 0x0496E4F0, 0x30, 0x250, 0x87A;
}
